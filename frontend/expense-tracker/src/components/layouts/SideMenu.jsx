...
const SideMenu = ({ activeMenu }) => {
  ...
  return (
    <div className='w-63 h-[calc(100vh-61px)] bg-gray-800 border-r border-gray-400/50 p-5 shadow-xl shadow sticky top-[61px] z-20 flex flex-col justify-between backdrop-blur-[2px]'>
